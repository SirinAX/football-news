...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-)hpzqlz9d2-+&*x5#&1*&(w-g)yo_pm-1#!hm8t)nxce3_!3a)')
...
# Allowed hosts
ALLOWED_HOSTS = ["localhost", "127.0.0.1","andi-hakim42-footballnews.pbp.cs.ui.ac.id","10.0.2.2"]
